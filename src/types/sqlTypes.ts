...
export const SQL_TYPE_OPTIONS: SqlTypeOption[] = [
  ...
  { value: 'UUID', label: 'UUID', group: 'Document / Binary', description: 'PostgreSQL native universally unique identifiers for distributed IDs and records.', dialects: ['postgresql'] },
  { value: 'CHAR(36)', label: 'CHAR(36)', group: 'Document / Binary', description: 'MySQL fixed-length UUID storage using canonical 36-character text.', dialects: ['mysql'] },
