...
export const useQueryStore = defineStore('query', () => {
  ...
  function removeWhere(id: string) { wheres.value = wheres.value.filter(w => w.id !== id) }
  ...
  function removeOrder(id: string) { orders.value = orders.value.filter(o => o.id !== id) }
  ...
  function removeGroup(id: string) { groups.value = groups.value.filter(g => g.id !== id) }
